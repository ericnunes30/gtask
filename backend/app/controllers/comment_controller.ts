...
export default class CommentsController {
    ...
    async update({ request, params, response, auth }: HttpContext) { // auth adicionado
        try {
    ...
    async findByTask({ params, request, response }: HttpContext) {
        try {
            ...
            const comments = await Comment.query()
                ...
                .withCount('replies', (query) => { // Adiciona a contagem de respostas diretas
    ...
    async findReplies({ params, request, response }: HttpContext) {
        try {
            ...
            const replies = await Comment.query()
                ...
                .withCount('replies', (query) => { // Adiciona a contagem de sub-respostas (respostas das respostas)
                    query.as('repliesCount')
                })
    ...
    async removeLike({ params, auth, response }: HttpContext) {
        ...
        try {
            ...
            if (relatedComment) {
                ...
                if (relatedComment.task) { // Verifica se a tarefa foi carregada com sucesso
                    await ActivityLog.create({
