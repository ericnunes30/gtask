...
### 4. TypeError: Cannot read properties of undefined (reading 'currentUser')
**Arquivo:** `frontend/src/services/backend/profile/index.ts`
**Linha:** 59
**Problema:** Tentando acessar `queryKeys.userKeys.currentUser` mas o caminho correto é diferente.
**Solução:** Usar `['currentUser']` diretamente

**Antes:**
```typescript
invalidateKeys: [
  queryKeys.users.lists(),
  queryKeys.userKeys.currentUser,
],
```
