  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      if (user.roles && Array.isArray(user.roles)) {
        ...
        isAdmin = roleNames.includes('Administrador') || roleNames.includes('ADMIN');
        isManager = roleNames.includes('Gerente') || roleNames.includes('GERENTE');
        isMember = roleNames.includes('Membro') || roleNames.includes('MEMBRO');
        isGuest = roleNames.includes('Convidado') || roleNames.includes('CONVIDADO');
