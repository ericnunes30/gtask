...
const TaskDetailsModal: React.FC<TaskDetailsModalProps> = ({
  ...
  const handleSaveFullScreenContent = (content: string) => {
    ...
    // Não fechar aqui - o FullScreenEditorModal já cuida do fechamento
  };
          ...
          <div className="w-1/2 border-r overflow-y-auto p-6">
            ...
            <div className="mb-6 mt-4">
              ...
              {isEditMode && !permissions.isMember ? (
                ...
                <div id="task-description" className="prose dark:prose-invert text-sm p-3 border rounded-md bg-muted/30 min-h-[100px] overflow-auto">
                  {task.description ? (
