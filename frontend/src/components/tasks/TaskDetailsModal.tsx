...
import CommentItem from '@/components/comments/CommentItem'; // Importar o novo componente
                      ...
                      {(() => {
                        ...
                        return teamsToShow.map((team: any) => {
                          ...
                          const teamName = typeof team === 'number' ?
                            (teams.find(t => t.id === team)?.name || `Equipe ${team}`) :
                            team.name;
                                    ...
                                    {(() => {
                                      ...
                                      if (user.occupations && user.occupations.length > 0) {
                                        ...
                                        const teamNames = user.occupations.map((o: any) => {
                                          if (typeof o === 'number') {
                                            const team = teams.find(t => t.id === o);
